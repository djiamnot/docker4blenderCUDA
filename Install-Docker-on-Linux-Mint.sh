# lifted from https://gist.github.com/sirkkalap/e87cd580a47b180a7d32
##########################################
# To run: 
...
sudo echo -c 'deb https://get.docker.com/ubuntu docker main > /etc/apt/sources.list.d/docker.list'
